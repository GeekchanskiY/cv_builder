drop table if exists responsibility_conflicts cascade ;
drop table if exists responsibility_synonyms cascade ;
drop table if exists project_domains cascade ;
drop table if exists project_services cascade ;
drop table if exists vacancy_domains cascade ;
drop table if exists vacancy_skills cascade ;
drop table if exists skill_conflicts cascade ;
drop table if exists skill_domains cascade ;
drop table if exists cv_build_statuses cascade;
